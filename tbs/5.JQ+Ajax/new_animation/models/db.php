...
class DB
{
	...
	var $user = 'root';
	var $password = '';
	var $database = 'animation_project';
	...
	function __construct($host = '', $user = '', $password = '', $database = '')
	{
		...
		$con = mysql_connect($this->host, $this->user,$this->password) OR die('Could not connect to mysql Server');
		mysql_select_db($this->database) OR die('Could not connect to mysql database '.$this->database);
	}
