...
<div style="background-color:green;color:#fff; text-align:center;" id="msg"></div>
<table cellpadding="10px" cellspacing="0px" width="90%" align="center" border="1" >
			...
			<tr id="tr_<?php echo $rows['id']; ?>">
				...
				<td>
				<a href="javascript:void(0)" class="edit" id="<?php echo $rows['id'];?>">Edit</a> <a href="javascript:void(0)" class="save" id="<?php echo $rows['id'];?>" name="save_<?php echo $rows['id'];?>">Save</a> | 
