...
/*----------------------Code for show testimonials--------------*/
$testimonials = new testimonials;
$sql=$testimonials->select($testimonials->table,'',"id='".$_GET['id']."'");
//print_r($sql);exit;
/*----------------------Code End for show testimonials--------------*/

?>
<html>
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  <title>Show Testimonials</title>
...
<body>
    <div id="container">
        ...
        <div class="block" id="block-tables">
          ...
          <div class="content">
            <h2 class="title">Show Testimonials</h2>
			...
			<form method="post" class="form" enctype="multipart/form-data">
				<table align="center" cellpadding="10px" cellspacing="10px" width="840px" border="0" align="center">
					 ...
					 <tr>
						 ...
						 <td><strong><?php echo $sql[0]['detail'];?></strong></td>
					 </tr>
					  <tr>
					 ...
					 <tr>
					    <td>
						  <div class="actions-bar wat-cf">
						    <div class="actions">
                              <button class="button" type="button" name="back" onclick="windows:location='testimonials.php';">
