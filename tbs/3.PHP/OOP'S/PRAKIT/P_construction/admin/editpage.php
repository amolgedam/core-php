...
$pages = new pages;
$update = ($pages->select($pages->table,'',"id='".$_GET['id']."'"));
{
if(isset($_POST['update']))
{
	if($pages->save($pages->table,$_POST,"id=".$_GET['id'].""))
	{
	    $msg="Update Sucess";
			...
			<form method="post" class="form" enctype="multipart/form-data">
				<table align="center" cellpadding="10px" cellspacing="10px" width="840px" border="0" align="center">
					 ...
					 <tr>
						 ...
						 <td><textarea  class="ckeditor" rows="5" col="300" style="width:500px; height:200px;"class="text_field" name="description"><?php echo $update[0]['description']?></textarea></td>
					 </tr>
					 <tr>
					     <td>&nbsp;</td>
						 <td>
